...
void initMenu() {
    ...
    playBtnBounds = (Rectangle){ WINDOW_WIDTH/2.0f - playButton.width/2.0f, 400, (float)playButton.width, playButtonFrame };
    creditBtnBounds = (Rectangle){ WINDOW_WIDTH/2.0f - creditButton.width/2.0f, 520 , (float)creditButton.width, creditButtonFrame };
    quitBtnBounds = (Rectangle){ WINDOW_WIDTH/2.0f - quitButton.width/2.0f, 640, (float)quitButton.width, quitButtonFrame };
    logoBounds = (Rectangle){WINDOW_WIDTH/50.0f - logo.width/10.0f,-360, (float)logo.width, logoFrame};
